...
<body class="bg-slate-50 flex flex-col min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 py-12 flex-grow">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-4xl font-bold text-sky-700 mb-2">Kelola Kereta</h1>
                <p class="text-slate-600">Kelola data kereta dan kapasitasnya</p>
            </div>
            <a href="<%= request.getContextPath() %>/admin-manage?action=add_train_form" class="px-6 py-3 bg-gradient-to-r from-sky-500 to-blue-700 text-white font-bold rounded-lg hover:-translate-y-0.5 transition shadow-lg">
                + Tambah Kereta
            </a>
        </div>
                ...
                <table class="w-full">
                    <thead class="bg-slate-50 border-b-2 border-slate-200">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left font-bold text-slate-700">Nama Kereta</th>
                            <th class="px-6 py-4 text-left font-bold text-slate-700">Kelas</th>
                            <th class="px-6 py-4 text-left font-bold text-slate-700">Kapasitas</th>
                    ...
                    <tbody>
                        ...
                        %>
                                    <tr class="border-b border-slate-100 hover:bg-slate-50">
                                        <td class="px-6 py-4 font-bold text-sky-700"><%= t.getCode() %></td>
                        ...
                        %>
                                <tr>
                                    <td colspan="5" class="px-6 py-8 text-center text-slate-600">
                                        Belum ada data kereta. <a href="<%= request.getContextPath() %>/admin-manage?action=add_train_form" class="text-sky-600 font-bold hover:underline">Tambah kereta pertama</a>
                                    </td>
                                </tr>
                        <%
                            }
