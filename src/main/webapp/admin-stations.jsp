    ...
    <div class="flex-1 flex flex-col h-full md:h-screen overflow-y-auto">
        ...
        <header class="bg-white shadow-sm">
            <div class="px-6 py-4 flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Kelola Stasiun</h1>
                    <p class="text-gray-600">Tambah, edit, dan hapus stasiun kereta</p>
                </div>
        ...
        <main class="flex-1 p-6 bg-gray-50">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
                <div>
                    ...
                    <h1 class="text-3xl font-bold text-gray-800">Kelola Stasiun</h1>
                    <p class="text-gray-600">Tambah, edit, dan hapus stasiun kereta</p>
                </div>
                <a href="<%= request.getContextPath() %>/admin-manage?action=add_station_form" class="px-6 py-3 bg-gradient-to-r from-red-500 to-red-700 text-white font-bold rounded-lg hover:-translate-y-0.5 transition shadow-lg">
                    + Tambah Stasiun
                </a>
            </div>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50 border-b-2 border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left font-bold text-gray-700">Nama Stasiun</th>
                                <th class="px-6 py-4 text-left font-bold text-gray-700">Kota</th>
                        ...
                        <tbody>
                            ...
                            %>
                                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                                            <td class="px-6 py-4 font-bold text-red-700"><%= s.getCode() %></td>
                            ...
                            %>
                                    <tr>
                                        <td colspan="4" class="px-6 py-8 text-center text-gray-600">
                                            Belum ada data stasiun. <a href="<%= request.getContextPath() %>/admin-manage?action=add_station_form" class="text-red-600 font-bold hover:underline">Tambah stasiun pertama</a>
                                        </td>
                                    </tr>
                            <%
                                }
