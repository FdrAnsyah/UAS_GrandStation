...
<head>
    ...
    <title>Tambah dan Edit Stasiun - GrandStation</title>
...
<body class="bg-gray-100 h-screen flex flex-col md:flex-row overflow-hidden">
    ...
    <aside class="sidebar-gradient text-white w-full md:w-64 h-screen flex flex-col overflow-y-hidden">
        <div class="p-6">
            ...
            <nav class="space-y-1">
                ...
                <a href="<%= request.getContextPath() %>/admin-manage?action=manage_stations" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-white/20 hover:bg-white/30 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="p-4 bg-black/10 mt-auto">
    ...
    <div class="flex-1 flex flex-col overflow-y-auto">
        ...
        <header class="bg-white shadow-sm">
            <div class="px-6 py-4 flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Tambah dan Edit Stasiun</h1>
                    <p class="text-gray-600">Isi form di bawah untuk menambahkan atau mengedit stasiun</p>
                </div>
        ...
        <main class="flex-1 p-6 bg-gray-50 overflow-y-auto">
            ...
            <div class="mb-8">
                <%
                    ...
                    String title = station != null ? "Edit Stasiun" : "Tambah Stasiun Baru";
                    String subtitle = station != null ? "Ubah informasi stasiun berikut" : "Isi form di bawah untuk menambahkan stasiun baru";
                %>
            ...
            <div class="bg-white rounded-xl shadow border border-gray-200 p-8 max-w-2xl mx-auto">
                ...
                <form method="POST" action="<%= request.getContextPath() %>/admin-manage" class="space-y-6">
                    ...
                    <div>
                        ...
                        >
                        <p class="text-xs text-gray-500 mt-1">Kode harus unik (3-10 karakter)</p>
                    </div>
    ...
    <script>
        // Tidak ada mobile sidebar toggle diperlukan - sidebar sudah static
    </script>
</body>
</html>
