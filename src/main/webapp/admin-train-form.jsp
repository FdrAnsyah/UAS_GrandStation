...
<head>
    ...
    <title><%= (request.getAttribute("train") != null) ? "Edit Kereta" : "Tambah Kereta Baru" %> - GrandStation</title>
...
<body class="bg-gray-100 h-screen flex flex-col md:flex-row overflow-hidden">
    ...
    <aside class="sidebar-gradient text-white w-full md:w-64 h-screen flex flex-col overflow-y-hidden">
        ...
        <div class="absolute bottom-0 w-64 p-4 bg-black/10">
            ...
            <div class="px-6 py-4 flex items-center justify-between">
                <div>
                    <%
                        ...
                        String title = isEdit ? "Edit Kereta" : "Tambah Kereta Baru";
                        String subtitle = isEdit ? "Ubah informasi kereta berikut" : "Lengkapi informasi kereta di bawah";
                    %>
        ...
        <main class="flex-1 p-6 bg-gray-50 overflow-y-auto">
            ...
            %>
                <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded">
                    <p class="text-red-700 font-semibold">Gagal <%= isEdit ? "mengupdate" : "menambahkan" %> kereta. Silakan coba lagi.</p>
                </div>
            <% } %>

            <!-- Form Card -->
            <div class="bg-white rounded-xl shadow border border-gray-200 p-8 max-w-2xl mx-auto">
                <%
                    String action = isEdit ? "update_train" : "add_train";
                    String buttonText = isEdit ? "Perbarui Kereta" : "Tambah Kereta";
                %>
                ...
                <form method="POST" action="<%= request.getContextPath() %>/admin-manage" class="space-y-6">
                    ...
                    <div>
                        <label for="code" class="block text-sm font-semibold text-gray-700 mb-2">
                            Kode Kereta <span class="text-red-500">*</span>
                        </label>
                        <input
                            type="text"
                            id="code"
                            ...
                            value="<%= isEdit ? train.getCode() : "" %>"
                            required
                            maxlength="10"
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 uppercase"
                        >
                        <p class="text-xs text-gray-500 mt-1">Kode unik untuk identifikasi kereta</p>
                    </div>
                    ...
                    <!-- Kelas Kereta -->
                    <div>
                        <label for="train_class" class="block text-sm font-semibold text-gray-700 mb-2">
                    ...
                    <!-- Total Kursi -->
                    <div>
                        <label for="seats_total" class="block text-sm font-semibold text-gray-700 mb-2">
                        ...
                        <input
                            ...
                            value="<%= isEdit ? train.getSeatsTotal() : "" %>"
                            required
                            min="1"
                            max="1000"
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                        >
                        <p class="text-xs text-gray-500 mt-1">Jumlah kursi yang tersedia di kereta</p>
                    </div>
                    ...
                    <div class="flex gap-4 pt-6 border-t-2 border-gray-100">
                        ...
                        <a
                            href="<%= request.getContextPath() %>/admin-manage?action=manage_trains"
            ...
            <!-- Info Box -->
            <div class="mt-8 p-4 bg-red-50 border-l-4 border-red-500 rounded max-w-2xl mx-auto">
                <p class="text-sm text-red-800">
                    <strong>Catatan:</strong> Pastikan informasi kereta lengkap dan akurat sebelum menyimpan.
                </p>
            </div>
        </main>
    </div>
