    ...
    <div class="flex-1 flex flex-col h-full md:h-screen overflow-y-auto">
        ...
        <header class="bg-white shadow-sm">
            <div class="px-6 py-4 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600">Kelola jadwal keberangkatan dan jadwal tiba</p>
                </div>
        ...
        <main class="flex-1 p-6 bg-gray-50">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
                ...
                <a href="<%= request.getContextPath() %>/admin-manage?action=add_schedule_form" class="px-6 py-3 bg-gradient-to-r from-red-500 to-red-700 text-white font-bold rounded-lg hover:-translate-y-0.5 transition shadow-lg">
                    + Tambah Jadwal
                </a>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-gray-50 border-b-2 border-gray-200">
                            <tr>
                                <th class="px-6 py-4 text-left font-bold text-gray-700">Kereta</th>
                                <th class="px-6 py-4 text-left font-bold text-gray-700">Rute</th>
                                <th class="px-6 py-4 text-left font-bold text-gray-700">Berangkat</th>
                                <th class="px-6 py-4 text-left font-bold text-gray-700">Tiba</th>
                                <th class="px-6 py-4 text-left font-bold text-gray-700">Harga</th>
                                <th class="px-6 py-4 text-left font-bold text-gray-700">Kursi</th>
                        ...
                        <tbody>
                            ...
                            %>
                                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                                            <td class="px-6 py-4">
                                                <div class="font-bold text-red-700"><%= s.getTrain().getName() %></div>
                                                <div class="text-xs text-gray-500"><%= s.getTrain().getCode() %> &bull; <%= s.getTrain().getTrainClass() %></div>
                                            </td>
                                            <td class="px-6 py-4">
                            ...
                            %>
                                    <tr>
                                        <td colspan="7" class="px-6 py-8 text-center text-gray-600">
                                            Belum ada data jadwal. <a href="<%= request.getContextPath() %>/admin-manage?action=add_schedule_form" class="text-red-600 font-bold hover:underline">Tambah jadwal pertama</a>
                                        </td>
                                    </tr>
                            <%
                                }
